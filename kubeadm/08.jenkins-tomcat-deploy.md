...
- **확장**: 05번 Argo CD와 연동하려면 **09번 문서** [Jenkins 빌드 이미지를 Argo CD로 Kubernetes Pod 배포 가이드](09.jenkins-argocd-deploy.md)를 참고하세요. Jenkins는 이미지 푸시만 하고 이미지 태그를 Git에 반영한 뒤 Argo CD가 Pod로 배포하도록 구성할 수 있습니다.
