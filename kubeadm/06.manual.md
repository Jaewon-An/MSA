...
| 04 | 04.jenkins-build.md | Jenkins CI 빌드 (파이프라인, 이미지 빌드·푸시) |
| 05 | 05.argocd-deploy.md | Argo CD CD 배포 (Git 기반 배포·동기화) |
...
| Jenkins | 04: Deployment+YAML 또는 Helm | `kubectl get pods -n jenkins`, http://\<노드IP\>:30080 |
